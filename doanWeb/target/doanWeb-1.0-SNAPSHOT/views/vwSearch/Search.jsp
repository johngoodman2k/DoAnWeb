...
<jsp:useBean id="listSearch" scope="request" type="java.util.List<beans.Course>"></jsp:useBean>
...
<t:category>
    <jsp:body>
        ...
        <div class="card-header">
            <h4> Kết quả tìm kiếm với: ${keyword}</h4>
        </div>
        ...
        <c:choose>
            ...
            <c:otherwise>
                    <c:forEach var="c" items="${listSearch}">
